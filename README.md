...
1. افتح الإعدادات وتأكد أن الإصدار الظاهر هو `V6.1.1`.
2. اضغط **تفعيل الإشعارات**؛ يجب أن يظهر طلب Chrome الحقيقي أو رسالة حالة واضحة، ولا تظهر الرسالة القديمة المضللة.
3. في المزامنة، لا تعتبر الحالة ناجحة إلا إذا ظهرت `Synced ✓` ووقت **آخر مزامنة ناجحة** بعد الاتصال الفعلي.
4. أنشئ جلسة تجريبية، أنهِها، افتح الفاتورة واضغط **طباعة / PDF** للتأكد من ظهور فاتورة منفصلة واضحة.
5. عند وجود نسخة قديمة على الهاتف، استخدم **تحديث إجباري آمن** من الإعدادات ثم افتح التطبيق مرة أخرى.
